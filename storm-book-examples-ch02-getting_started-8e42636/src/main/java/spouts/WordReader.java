...
public class WordReader extends BaseRichSpout {
	...
	public void ack(Object msgId) {
		System.err.println("WordReader.ack(),msgId="+msgId);
	}
	@Override
	public void close() {
		System.err.println("WordReader.close()");
	}
	@Override
	public void fail(Object msgId) {
		System.err.println("WordReader.fail(),FAIL:" + msgId);
	}
	...
	public void nextTuple() {
		System.err.println("WordReader.nextTuple()");
		/**
	...
	public void open(Map conf, TopologyContext context, SpoutOutputCollector collector) {
		...
		System.err.println("WordReader.open()");
		try {
			this.context = context;
			Object filePath = conf.get("wordsFile");
			//创建reader负责读文件
	...
	public void declareOutputFields(OutputFieldsDeclarer declarer) {
		System.err.println("WordReader.declareOutputFields()");
